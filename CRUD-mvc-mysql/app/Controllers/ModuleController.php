<?php
    ...
    class ModuleController{
        ...
        private function getDataModel(){
            ...
            $getModel['module_name'] = empty($dataRequest['name']) ? '' : $dataRequest['name'];
            $getModel['module_route'] = empty($dataRequest['route']) ? '' : $dataRequest['route'];
            $getModel['module_description'] = empty($dataRequest['description']) ? '' : $dataRequest['description'];
            return $getModel;
        }
    }
?>